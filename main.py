...
async def root() -> dict[str, str]:
    """Return a friendly root response for quick browser checks."""
    return {
        "message": "Glassport Gen backend is running.",
        "docs": "/docs",
        "portfolio_example": "/api/portfolio/octocat",
        "cv_example": "/api/cv/octocat",
    }
